    ...
    >
      <div className="login-modal-card">
        ...
        <div className="login-modal-logo">
          <div className="login-modal-logo-mark">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              <path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/>
              <path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/>
            </svg>
          </div>
          <span className="login-modal-logo-text">FSTUDY</span>
        </div>
        ...
        <form className="login-modal-form" onSubmit={(e) => e.preventDefault()}>
          ...
          {/* Sign In button */}
          <button id="login-submit-btn" type="submit" className="login-modal-submit">
            Sign In
        ...
        <div className="login-modal-socials">
          <button id="login-google-btn" className="login-modal-social-btn" type="button">
          ...
          <button id="login-apple-btn" className="login-modal-social-btn" type="button">
        ...
        <p className="login-modal-footer">
          ...
          <Link to="/register" className="login-modal-create-link" onClick={onClose}>
            Create Account
          </Link>
        </p>
