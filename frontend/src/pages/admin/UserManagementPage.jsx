...
function UserManagementPage() {
  ...
  return (
    <div className="admin-user-mgmt-container">
      ...
      {/* â”€â”€â”€â”€â”€â”€â”€â”€ MODAL OVERLAY â”€â”€â”€â”€â”€â”€â”€â”€ */}
      {(viewUser || editUser || deleteUser) && (
        <div className="modal-backdrop" onClick={closeAll} />
      )}

      {/* â”€â”€â”€â”€â”€â”€â”€â”€ VIEW MODAL â”€â”€â”€â”€â”€â”€â”€â”€ */}
      {viewUser && (
            ...
            <div className="view-modal-body">
              ...
              <div className="view-badges-row">
                <span className={`role-badge role-${viewUser.role.toLowerCase()}`}>
                  {/* SVG 1: Shield person â€“ USER badge */}
                ...
                <span className="view-status-badge">
                  {/* SVG 3: Shield check â€“ ACTIVE badge */}
              ...
              <div className="view-activity-grid">
                {/* Total Folders â€“ SVG 4: Folder blue */}
                ...
                {/* Tests Created â€“ SVG 5: Document with question mark */}
                <div className="view-activity-item">
              ...
              {/* Last Login + Location â€“ single full-width row */}
              <div className="view-activity-row-single">
                {/* Last Login â€“ left side: plain icon + text */}
                ...
                {/* Location â€“ right side: text only, no icon */}
              ...
              <div className="view-latest-action">
                <div className="view-latest-action-title">
                  {/* SVG 7: Refresh/redo â€“ Latest Action */}
      ...
      {/* â”€â”€â”€â”€â”€â”€â”€â”€ DELETE MODAL â”€â”€â”€â”€â”€â”€â”€â”€ */}
      {deleteUser && (
        <div className="modal-wrapper">
