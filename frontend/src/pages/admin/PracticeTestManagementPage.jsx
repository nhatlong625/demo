...
function PracticeTestManagementPage() {
  ...
  if (showReviewQueue) {
    const tabs = [
      { key: 'all',      label: 'All Pending', count: 12 },
      { key: 'low',      label: 'Low Confidence', count: 5 },
      { key: 'reported', label: 'Reported', count: 8, alert: true },
    ];
    const visible = activeTab === 'all' ? reviewQueueData : reviewQueueData.filter(q => q.type === activeTab);
    return (
      <>
              ...
              <div className="rq-actions">
                {q.type === 'low' ? (
                  <>
                    ...
                    <button className="rq-btn rq-btn-edit" onClick={() => setRqEdit(q)}>
                      <svg width="13" height="13" viewBox="0 0 24 24" fill="none">
        ...
        <div className="lib-modal-overlay" onClick={() => setRqReject(null)}>
          <div className="lib-modal-card lib-modal-delete" onClick={e => e.stopPropagation()}>
            ...
            <div className="lib-modal-footer">
              ...
              <button className="lib-modal-delete-btn" onClick={() => setRqReject(null)}>{rqReject.type === 'low' ? 'Reject' : 'Delete'}</button>
            </div>
          </div>
        </div>
      )}
          ...
          <div className="lib-modal-card rq-edit-modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="rq-edit-body">
              <div className="lib-form-group">
                ...
                <textarea className="lib-form-input rq-textarea" defaultValue={rqEdit.question} rows={3}/>
              </div>
              <div className="lib-form-group">
                <label className="lib-form-label">{rqEdit.type === 'low' ? 'Corrected Answer' : 'Fixed Answer'}</label>
                <textarea className="lib-form-input rq-textarea" defaultValue={rqEdit.aiAnswer || rqEdit.currentAnswer || ''} rows={3}/>
              </div>
              {rqEdit.flagNote && (
                <div className="rq-flag-note">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
            ...
            <div className="rq-edit-footer">
              ...
              <button className="rq-btn rq-btn-approve" style={{ padding: '10px 22px' }} onClick={() => setRqEdit(null)}>Save Changes</button>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="lib-modal-overlay" onClick={() => setRqApprove(null)}>
          <div className="lib-modal-card lib-modal-delete" onClick={e => e.stopPropagation()}>
            ...
            <div className="lib-modal-footer">
              ...
              <button className="rq-modal-approve-btn" onClick={() => setRqApprove(null)}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                  <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  <polyline points="22 4 12 14.01 9 11.01" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                {rqApprove.type === 'reported' ? 'Approve Fix' : 'Approve'}
              </button>
            </div>
          </div>
        </div>
  ...
  if (selectedTest) {
    const questions = questionsData[selectedTest.id] || [];
    const s = STATUS_CFG[selectedTest.status] || {};
    return (
      <div className="ptm-page">
        {/* Back */}
        <button className="ptm-back-btn" type="button" onClick={() => setSelectedTest(null)}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
            <path d="M19 12H5M12 19l-7-7 7-7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          Back to Practice Tests
        ...
        <div className="ptm-table-card">
          ...
          <div className="ptm-pagination">
            <span className="ptm-pagination-info">Showing 1 to {questions.length} of {selectedTest.questions} questions</span>
    ...
    <div className="ptm-page">
      ...
      <div className="ptm-stats-row">
        <div className="ptm-stat-card">
          ...
          <div className="ptm-stat-value">248</div>
        </div>
        <div className="ptm-stat-card">
          <div className="ptm-stat-label">AI GENERATED TESTS</div>
          <div className="ptm-stat-value ptm-stat-blue">190</div>
        </div>
        <div className="ptm-stat-card">
          <div className="ptm-stat-label">PENDING REVIEW</div>
          <div className="ptm-stat-value ptm-stat-orange">12</div>
        </div>
        <div className="ptm-stat-card">
          <div className="ptm-stat-label">PUBLISHED TESTS</div>
          <div className="ptm-stat-value">216</div>
        </div>
        <div className="ptm-stat-card">
          <div className="ptm-stat-label">AVERAGE SCORE</div>
          <div className="ptm-stat-value">78.4%</div>
        </div>
      </div>
      ...
      <div className="ptm-body">
        ...
        <div className="ptm-table-card">
                  ...
                  <tr key={test.id} className="ptm-row">
                    ...
                    <td>
                      <div className="ptm-actions">
                        {/* View */}
                        <button className="ptm-action-btn" aria-label="View" onClick={() => setSelectedTest(test)}>
          ...
          {/* Pagination */}
          <div className="ptm-pagination">
            <span className="ptm-pagination-info">Showing 1 to 4 of 248 entries</span>
            <div className="ptm-pagination-controls">
              <button className="ptm-page-btn" disabled>Prev</button>
              {[1,2,3].map(p => (
        ...
        <div className="ptm-sidebar">
          ...
          <div className="ptm-queue-list">
            <div className="ptm-queue-item ptm-queue-blue">
              ...
              <div>
                <div className="ptm-queue-count">12 questions</div>
            ...
            <div className="ptm-queue-item ptm-queue-red">
              ...
              <div>
                <div className="ptm-queue-count">5 questions</div>
            ...
            <div className="ptm-queue-item ptm-queue-purple">
              ...
              <div>
                <div className="ptm-queue-count">8 questions</div>
      ...
      <div className="lib-modal-overlay" onClick={() => setDeleteTest(null)}>
        <div className="lib-modal-card lib-modal-delete" onClick={e => e.stopPropagation()}>
          ...
          <div className="lib-modal-footer">
            ...
            <button className="lib-modal-delete-btn" type="button" onClick={() => setDeleteTest(null)}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                <polyline points="3 6 5 6 21 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                <path d="M19 6l-1 14H6L5 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M10 11v6M14 11v6" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
